...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `onixcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ onixcore-node add wallet-service');
      console.log('    $ onixcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ onixcore-node remove wallet-service');
      console.log('    $ onixcore-node remove insight-api');
      console.log();
    });
