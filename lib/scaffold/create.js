...
var BASE_PACKAGE = {
  ...
  dependencies: {
    ...
    'onixcore-lib': 'https://github.com/onixcoin-io/onixcore-lib.git#master',
    'onixcore-node': 'https://github.com/onixcoin-io/onixcore-node.git#master'
  }
};
...
function createConfigDirectory(options, configDir, isGlobal, done) {
  mkdirp(configDir, function(err) {
    ...
    try {
      fs.writeFileSync(configDir + '/onixcore-node.json', configJSON);
      if (!isGlobal) {
...
function create(options, done) {
  ...
  async.series([
    function(next) {
      // Setup the the onixcore-node directory and configuration
